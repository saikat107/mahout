...
def init_hf_lstm_biencoder(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError('Please install transformers lib')
    from .hf_models import get_lstm_biencoder_components
    return get_lstm_biencoder_components(args, **kwargs)
...
BIENCODER_INITIALIZERS = {
    ...
    'hf_lstm': init_hf_lstm_biencoder,
...
TENSORIZER_INITIALIZERS = {
    ...
    'hf_lstm': init_hf_roberta_tenzorizer,
